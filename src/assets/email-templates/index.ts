...
<body>
 ...
 reservaAprobadaTemplate: (datos: ReservaAprobadaData) => `
<body style="margin: 0;
            padding: 0;
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background-color: #f4f4f4;">
...
`,
 ...
 reservaRechazadaTemplate: (datos: ReservaRechazadaData) => `
<body style="margin: 0;
            padding: 0;
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background-color: #f4f4f4;">
...
export const reservaAprobada = EmailTemplates.reservaAprobadaTemplate;
export const reservaRechazada = EmailTemplates.reservaRechazadaTemplate; 
