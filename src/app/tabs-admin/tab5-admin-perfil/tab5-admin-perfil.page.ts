...
@Component({
  selector: 'app-tab5-admin-perfil',
  templateUrl: './tab5-admin-perfil.page.html',
  styleUrls: ['./tab5-admin-perfil.page.scss'],
  standalone: false
})
export class Tab5AdminPerfilPage implements OnInit {
  ...
  constructor(
    ...
    console.log('Perfil recibido en Tab5 Admin Cliente:', this.perfil);
  }
