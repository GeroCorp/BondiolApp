...
// //           //   if(notification.additionalData['aca va url']){
...
// //         sendAfter: moment(notification.date).tz(userTimezone).format('YYYY-MM-DD HH:mm:ss [GMT]Z')
// //       },
// //       headers: {
...
//    */
//   sendNotificationToAdmins(title: string, body: string, url: string = '') {
//     return CapacitorHttp.post({
//       url: 'https://onesignal.com/api/v1/notifications',
//       params: {},
//       data: {
...
//       }
//     }).then((response: HttpResponse) => {
//       console.log('Notificación a admins enviada:', response);
//       return response.status === 200;
//     }).catch(err => {
